    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                ...
                HStack { stat("\(model.posts.count)", "动态"); Spacer(); stat("\(model.followCount)", "关注"); Spacer(); stat("\(model.fansCount)", "粉丝") }.padding(.horizontal)
...
@MainActor final class OtherUserProfileModel: ObservableObject {
    ...
    var followCount = 0; var fansCount = 0
...
struct OtherUserInfo: Decodable { let id: Int; let headPortrait: String?; let nickName: String?; let city: String?; let followStatus: String? }
